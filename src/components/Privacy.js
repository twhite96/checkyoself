  ...
  <React.Fragment>
    ...
    <div className="container is-fluid content">
      ...
      <p>
        ...
        have associated with that data. Our Privacy Policy for Check Yo Self is
        managed through{' '}
      ...
      <p>
        Check Yo Self will take all steps reasonably necessary to ensure that
      ...
      <p>
        Check Yo Self may disclose your Personal Data in the good faith belief
        that such action is necessary to:
      </p>
      <ul>
        <li>To comply with a legal obligation</li>
        <li>To protect and defend the rights or property of Check Yo Self</li>
        <li>
      ...
      <ul>
        <li>
          By email:{' '}
          <a href="mailto:feedback@tiffanyrwhite.com">
            feedback@tiffanyrwhite.com
          </a>
        </li>
      </ul>
    </div>
